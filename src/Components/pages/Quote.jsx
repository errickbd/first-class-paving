...
import '../../App.css';
import './Quote.css'
import fcpOrangeLogo from '../../photos/fcporangelogo.jpeg'
...
export default function Quote(){
    ...
    return(
        <div className="about-page-container-quote">
            
            <div className="about-section-container-quote">
                <h2 className="h2-quote">Connect with us</h2>
                <img className="img-quote" src={fcpOrangeLogo} alt="" width="500" height="400" /><br/><br/>
                {/* <h2>Inquire</h2>
                <br />
                <p><span>Welcome to First Class Paving!</span> <br /> <br/>
            ...
            <div className="form-section-container-quote">
